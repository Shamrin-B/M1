...
int main() {
    ...
    printf("Minimum fraction value is: %f\n", min);
    return 0;
}
```
## OUTPUT:
```
1.Enter numerator and denominator of first fraction: 1 2
 Enter numerator and denominator of second fraction: 3 4
 Minimum fraction value is: 0.500000
```
## RESULT:
...
## OUTPUT:
```
1.Enter marks for three subjects: 70 65 80
  Total = 215.00
  Percentage = 71.67
  Division = First
2.Enter marks for three subjects: 45 50 40
  Total = 135.00
  Percentage = 45.00
  Division = Second
3.Enter marks for three subjects: 30 55 65
  Total = 150.00
  Percentage = 50.00
   Division = Fail
```
